...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['employee_id'], ['tpc_employees.id'], ondelete="CASCADE"),
    )
    op.create_index('ix_emp_docs_employee_id', 'tpc_employee_documents', ['employee_id'])
    ...
    op.create_index('ix_emp_emergency_employee_id', 'tpc_employee_emergency_contacts', ['employee_id'])
    ...
    op.create_index('ix_emp_history_employee_id', 'tpc_employee_employment_history', ['employee_id'])
    ...
    op.create_index('ix_emp_ref_employee_id', 'tpc_employee_references', ['employee_id'])
...
def downgrade() -> None:
    ...
    op.drop_index('ix_emp_history_employee_id', table_name='tpc_employee_employment_history')
    op.drop_index('ix_emp_emergency_employee_id', table_name='tpc_employee_emergency_contacts')
