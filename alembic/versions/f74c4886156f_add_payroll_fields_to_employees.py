...
def upgrade():
    op.add_column(
        "tpc_employees", sa.Column("daily_rate", sa.Numeric(10, 2), nullable=True)
    )

    op.add_column(
        "tpc_employees", sa.Column("employment_type", sa.String(20), nullable=True)
    )

    op.add_column(
        "tpc_employees", sa.Column("payroll_type", sa.String(20), nullable=True)
    )
